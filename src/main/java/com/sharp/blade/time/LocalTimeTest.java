...
//		testNewOldDateConversion();
    ...
    public static void testDifferenceLocalAndZone() {
        String paramDate = "2019-06-28 00:00:00";
    ...
    public static void testMillis() {
        ...
        Clock c33 = Clock.system(ZoneId.of("America/Los_Angeles"));// 美国洛杉矶
        System.out.println("洛杉矶时区"+c33.instant());// 每次调用将返回当前瞬时时间（UTC）
        System.out.println("当前时区"+Clock.systemUTC().instant());
        System.out.println("默认时区"+Clock.systemDefaultZone().instant());
        System.out.println("Date时区"+date.toInstant());
